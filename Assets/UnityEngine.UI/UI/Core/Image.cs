...
namespace UnityEngine.UI
{
    ...
    public class Image : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        /// <summary>
        /// Amount of the Image shown when the Image.type is set to Image.Type.Filled.0-1 range with 0 being nothing shown, and 1 being the full Image.
        /// </summary>
        ...
        /// <summary>
        /// Update the UI renderer mesh. Callback function when a UI element needs to generate vertices.
        /// </summary>
        ...
        void GenerateFilledSprite(VertexHelper toFill, bool preserveAspect)
        {
            ...
            if (m_FillAmount < 0.001f)//若满足条件，则不会绘制
                return;
